  ...
  <head>
    ...
    <style>
      ...
      .footer-col h5 { font-weight: bold; margin-bottom: 10px; }
      .footer-col ul { list-style: none; padding-left: 0; }
      .footer-col ul li a { text-decoration: none; color: #fff; transition: color 0.3s; }
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          @if(Session::get('user_role') == 1)
              <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/danh-sach-nguoi-dung*') ? 'active' : '' }}" href="/admin/danh-sach-nguoi-dung">Quản Lý Người dùng</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/quan-ly-san-pham*') ? 'active' : '' }}" href="/admin/quan-ly-san-pham">Quản Lý Sản phẩm</a>
              </li>
          @endif
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-outline-danger btn-sm ms-2" href="{{ url('/admin/logout') }}">Đăng xuất</a>
            </li>
          @else
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/login') ? 'active' : '' }}" href="/admin/login">Đăng nhập</a>
            </li>
          @endif
        </ul>
      </div>
